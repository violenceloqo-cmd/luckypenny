  ...
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden bg-[#050508]">
      <div
        ...
        style={{
          background: `
            radial-gradient(ellipse 90% 70% at 50% 0%, rgba(153, 69, 255, 0.22) 0%, transparent 55%),
            ...
            radial-gradient(ellipse 100% 50% at 50% 100%, rgba(255, 138, 61, 0.08) 0%, transparent 45%),
      ...
      <div
        ...
        style={{
          background: "linear-gradient(to top, rgba(153, 69, 255, 0.12), transparent)",
        }}
        aria-hidden="true"
      />
    </div>
